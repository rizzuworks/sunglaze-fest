  ...
  return (
    <footer className="max-h-[100vh] bg-gradient-to-b from-terra to-ink text-paper pt-32 flex flex-col items-center justify-end overflow-hidden relative">
      ...
      <div className="w-full max-w-4xl mx-auto px-6 mb-16 text-center relative z-20">
        ...
        <h3 className="font-serif italic text-3xl md:text-5xl leading-tight mb-12 opacity-90 text-paper">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 font-sans text-xs md:text-sm uppercase tracking-[0.2em]">
          ...
          <div className="flex items-center gap-6 text-xl">
            <a 
              ...
              className="hover:text-sand hover:scale-110 transition-all duration-300" 
